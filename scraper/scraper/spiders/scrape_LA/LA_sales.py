...
class RedfinLASalesSpider(scrapy.Spider):
    ...
    custom_settings = {
        "BIGQUERY_TABLE": "LA_listings_sales",
        ...
        "FEEDS": {
            f"outputs/la/sales.ndjson": {"format": "jsonlines", "overwrite": True}
        },
    ...
    def _url(self, start: int) -> str:
        params = {"al": 1,"market": "socal","isRentals": "false","num_homes": 20, "start": start,"region_id": 11203,"region_type": 6,}
