...
class RedfinNYCSpider(scrapy.Spider):
    name = "NYC_sales"
    allowed_domains = ["redfin.com"]

    #got this from inspecting the network tab (Fetch/XHR) in the browser
    api_url = "https://www.redfin.com/stingray/api/gis?al=1&clustering_threshold=350&country_code=US&ep=true&isBrokerage=true&lpp=20&market=newyork&mpt=99&num_homes=350&ord=redfin-recommended-asc&page_number=1&poly=-74.16006%2040.34763%2C-73.7316%2040.34763%2C-73.7316%2041.27165%2C-74.16006%2041.27165%2C-74.16006%2040.34763&region_id=30749&region_type=6&school_types=1,2,3&sf=1,2,3,5,6,7&start=0&status=9&uipt=1,2,3,4,5,6,7,8&v=8&zoomLevel=10"
