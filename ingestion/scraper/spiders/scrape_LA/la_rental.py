...
class RedfinLARentalSpider(scrapy.Spider):
    ...
    def __init__(self, rpm: float = 5, jitter: float = 0.25, start_index: int = 0, max_pages: int = 300, **kwargs):
        ...
        self.rpm = float(rpm)               # requests per minute
        self.jitter = float(jitter)         # +/- 25% randomness
    ...
    custom_settings = {
        "BIGQUERY_TABLE": "LA_listings_rentals",
        ...
        "FEEDS": {
            f"outputs/la/rentals.ndjson": {"format": "jsonlines", "overwrite": True}
        },
        "DEFAULT_REQUEST_HEADERS": {
            "User-Agent": "Mozilla/5.0",
            "Referer": "https://www.redfin.com/city/11203/CA/Los-Angeles",
        },
    }

    def _url(self, start: int) -> str:
        params = {"al": 1,"market": "socal","isRentals": "true","num_homes": 20, "start": start,"region_id": 11203,"region_type": 6,}
