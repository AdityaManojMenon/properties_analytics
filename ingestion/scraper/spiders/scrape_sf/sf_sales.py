...
class RedfinSFRentalSpider(scrapy.Spider):
    ...
    api_url = "https://www.redfin.com/stingray/api/gis?al=1&clustering_threshold=350&country_code=US&ep=true&isRentals=true&isSearchFormParamsDefault=true&lpp=20&market=newyork&mpt=99&num_homes=350&ord=redfin-recommended-asc&page_number=1&poly=-74.04643%2040.4828%2C-73.8322%2040.4828%2C-73.8322%2040.94549%2C-74.04643%2040.94549%2C-74.04643%2040.4828&region_id=30749&region_type=6&sf=1,2,3,5,6,7&start=0&status=9&uipt=1,2,3,4&v=8&zoomLevel=11"

    custom_settings = {
        "BIGQUERY_TABLE": "SF_listings_sales",
        ...
        "FEEDS": {
            f"outputs/sf/sales.ndjson": {"format": "jsonlines", "overwrite": True}
        },
    ...
    def _url(self, start: int) -> str:
        params = {"al": 1,"market": "socal","isRentals": "false","num_homes": 20, "start": start,"region_id": 30749,"region_type": 6,}   
